...
// MARK: - WAMR natives: thin exec-env adapters onto the backend's own
// KitABI implementations (one renderer serves the shell and the cart)

@_cdecl("wamr_js_log")
func wamr_js_log(_ e: OpaquePointer?, _ p: UnsafePointer<CChar>?, _ len: Int32) { js_log(p, len) }
@_cdecl("wamr_gfx_clear")
func wamr_gfx_clear(_ e: OpaquePointer?, _ rgba: UInt32) { gfx_clear(rgba) }
@_cdecl("wamr_gfx_save")
func wamr_gfx_save(_ e: OpaquePointer?) { gfx_save() }
@_cdecl("wamr_gfx_restore")
func wamr_gfx_restore(_ e: OpaquePointer?) { gfx_restore() }
@_cdecl("wamr_gfx_translate")
func wamr_gfx_translate(_ e: OpaquePointer?, _ x: Float, _ y: Float) { gfx_translate(x, y) }
@_cdecl("wamr_gfx_rotate")
func wamr_gfx_rotate(_ e: OpaquePointer?, _ d: Float) { gfx_rotate(d) }
@_cdecl("wamr_gfx_scale")
func wamr_gfx_scale(_ e: OpaquePointer?, _ x: Float, _ y: Float) { gfx_scale(x, y) }
@_cdecl("wamr_gfx_set_alpha")
func wamr_gfx_set_alpha(_ e: OpaquePointer?, _ a: Float) { gfx_set_alpha(a) }
@_cdecl("wamr_gfx_set_blend")
func wamr_gfx_set_blend(_ e: OpaquePointer?, _ m: Int32) { gfx_set_blend(m) }
...
func wamr_gfx_stroke_poly(_ e: OpaquePointer?, _ xy: UnsafePointer<Float>?, _ n: Int32,
    ...
    gfx_stroke_poly(xy, n, closed, t, rgba)
}
@_cdecl("wamr_gfx_fill_poly")
func wamr_gfx_fill_poly(_ e: OpaquePointer?, _ xy: UnsafePointer<Float>?, _ n: Int32, _ rgba: UInt32) {
    gfx_fill_poly(xy, n, rgba)
}
@_cdecl("wamr_gfx_fill_circle")
func wamr_gfx_fill_circle(_ e: OpaquePointer?, _ x: Float, _ y: Float, _ r: Float, _ rgba: UInt32) {
    gfx_fill_circle(x, y, r, rgba)
}
@_cdecl("wamr_gfx_stroke_circle")
func wamr_gfx_stroke_circle(_ e: OpaquePointer?, _ x: Float, _ y: Float, _ r: Float, _ t: Float, _ rgba: UInt32) {
    gfx_stroke_circle(x, y, r, t, rgba)
}
...
func wamr_gfx_stroke_rect(_ e: OpaquePointer?, _ x: Float, _ y: Float, _ w: Float, _ h: Float, _ t: Float, _ rgba: UInt32) {
    gfx_stroke_rect(x, y, w, h, t, rgba)
}
@_cdecl("wamr_evt_poll")
func wamr_evt_poll(_ e: OpaquePointer?, _ t: UnsafeMutablePointer<Int32>?, _ a: UnsafeMutablePointer<Int32>?,
                   _ b: UnsafeMutablePointer<Int32>?, _ c: UnsafeMutablePointer<Int32>?,
                   _ d: UnsafeMutablePointer<Int32>?) -> Int32 {
    evt_poll(t, a, b, c, d)
}
@_cdecl("wamr_snd_by_name")
func wamr_snd_by_name(_ e: OpaquePointer?, _ p: UnsafePointer<CChar>?, _ len: Int32) -> Int32 {
    snd_by_name(p, len)
}
@_cdecl("wamr_snd_play")
func wamr_snd_play(_ e: OpaquePointer?, _ buf: Int32, _ vol: Float, _ loop: Int32) -> Int32 {
    snd_play(buf, vol, loop)
}
@_cdecl("wamr_snd_stop")
func wamr_snd_stop(_ e: OpaquePointer?, _ v: Int32) { snd_stop(v) }
@_cdecl("wamr_snd_set_volume")
func wamr_snd_set_volume(_ e: OpaquePointer?, _ v: Int32, _ vol: Float) { snd_set_volume(v, vol) }
@_cdecl("wamr_snd_set_pan")
func wamr_snd_set_pan(_ e: OpaquePointer?, _ v: Int32, _ pan: Float) { snd_set_pan(v, pan) }
@_cdecl("wamr_store_get")
func wamr_store_get(_ e: OpaquePointer?, _ k: UnsafePointer<CChar>?, _ kl: Int32,
                    _ buf: UnsafeMutablePointer<CChar>?, _ cap: Int32) -> Int32 {
    store_get(k, kl, buf, cap)
}
@_cdecl("wamr_store_set")
func wamr_store_set(_ e: OpaquePointer?, _ k: UnsafePointer<CChar>?, _ kl: Int32,
                    _ v: UnsafePointer<CChar>?, _ vl: Int32) {
    store_set(k, kl, v, vl)
}
@_cdecl("wamr_gp_connected")
func wamr_gp_connected(_ e: OpaquePointer?, _ pad: Int32) -> Int32 { gp_connected(pad) }
