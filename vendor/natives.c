...
static void stub_gfx_snap_translation(wasm_exec_env_t e) {}
...
static void stub_gfx_set_line_style(wasm_exec_env_t e, int join, int cap, float miterLimit) {}
...
static void stub_gfx_draw_image(wasm_exec_env_t e, int img, float sx, float sy, float sw, float sh, float dx, float dy, float dw, float dh, uint32_t rgba) {}
static int stub_txt_width(wasm_exec_env_t e, int font, const char* utf8, int len, int sizePx, float spacing) { return 0; }
static void stub_gfx_draw_text(wasm_exec_env_t e, int font, const char* utf8, int len, float x, float y, int sizePx, uint32_t rgba, float spacing) {}
static void stub_gfx_set_text_baseline(wasm_exec_env_t e, int mode) {}
static int stub_img_by_name(wasm_exec_env_t e, const char* name, int len) { return 0; }
static int stub_img_width(wasm_exec_env_t e, int img) { return 0; }
static int stub_img_height(wasm_exec_env_t e, int img) { return 0; }
static int wamr_snd_by_name(wasm_exec_env_t e, const char* a0, int a1) { return snd_by_name(a0, a1); }
static int stub_snd_create_pcm(wasm_exec_env_t e, const float* samples, int frameCount, int sampleRate) { return 0; }
static int stub_font_by_name(wasm_exec_env_t e, const char* name, int len) { return 0; }
...
static int stub_snd_status(wasm_exec_env_t e, int voice) { return 0; }
static void stub_snd_pause_all(wasm_exec_env_t e) {}
static void stub_snd_resume_all(wasm_exec_env_t e) {}
...
static int stub_gfx_offscreen_begin(wasm_exec_env_t e, int w, int h) { return 0; }
static int stub_gfx_offscreen_end_to_image(wasm_exec_env_t e, int handle) { return 0; }
static void stub_gfx_offscreen_end_discard(wasm_exec_env_t e, int handle) {}
static void stub_gfx_free_image(wasm_exec_env_t e, int img) {}
static void stub_gfx_draw_shadow_image(wasm_exec_env_t e, int img, float x, float y, float w, float h, float blur, uint32_t rgba) {}
static void stub_gfx_set_filter(wasm_exec_env_t e, const char* utf8, int len) {}
static void stub_gfx_clear_filter(wasm_exec_env_t e) {}
static void stub_gfx_set_shadow(wasm_exec_env_t e, float blurRadius, float dx, float dy, uint32_t rgba) {}
static void stub_gfx_clear_shadow(wasm_exec_env_t e) {}
static void stub_gfx_set_composite(wasm_exec_env_t e, int mode) {}
...
static void stub_snd_set_rate(wasm_exec_env_t e, int voice, float rate) {}
static int stub_eng_player_create(wasm_exec_env_t e) { return 0; }
static void stub_eng_player_release(wasm_exec_env_t e, int id) {}
static int stub_eng_mixer_create(wasm_exec_env_t e) { return 0; }
static void stub_eng_node_set_volume(wasm_exec_env_t e, int id, float v) {}
static void stub_eng_node_set_pan(wasm_exec_env_t e, int id, float p) {}
static void stub_eng_connect(wasm_exec_env_t e, int src, int dst) {}
static int stub_eng_player_schedule_buffer(wasm_exec_env_t e, int player, int sound, int loops) { return 0; }
static void stub_eng_player_play(wasm_exec_env_t e, int id) {}
static void stub_eng_player_stop(wasm_exec_env_t e, int id) {}
static void stub_eng_start(wasm_exec_env_t e) {}
static void stub_eng_stop(wasm_exec_env_t e) {}
...
static int stub_gfx_upload_pixels(wasm_exec_env_t e, int img, int w, int h, const uint8_t* rgba, int len) { return 0; }
...
static int stub_asset_exists(wasm_exec_env_t e, const char* name, int len) { return 0; }
static int stub_asset_text(wasm_exec_env_t e, const char* name, int len, char* buf, int cap) { return 0; }
...
static int stub_win_width(wasm_exec_env_t e) { return 0; }
static int stub_win_height(wasm_exec_env_t e) { return 0; }
static void stub_win_set_title(wasm_exec_env_t e, const char* s, int len) {}
static void stub_win_request_fullscreen(wasm_exec_env_t e) {}
static void stub_win_exit_fullscreen(wasm_exec_env_t e) {}
static void stub_win_download(wasm_exec_env_t e, const char* name, int nlen, const char* data, int dlen) {}
...
NativeSymbol kit_natives[] = {
    ...
    { "gfx_snap_translation", (void *)stub_gfx_snap_translation, "()", NULL },
    ...
    { "gfx_set_line_style", (void *)stub_gfx_set_line_style, "(iif)", NULL },
    ...
    { "gfx_draw_image", (void *)stub_gfx_draw_image, "(iffffffffi)", NULL },
    { "txt_width", (void *)stub_txt_width, "(i*~if)i", NULL },
    { "gfx_draw_text", (void *)stub_gfx_draw_text, "(i*~ffiif)", NULL },
    { "gfx_set_text_baseline", (void *)stub_gfx_set_text_baseline, "(i)", NULL },
    { "img_by_name", (void *)stub_img_by_name, "(*~)i", NULL },
    { "img_width", (void *)stub_img_width, "(i)i", NULL },
    { "img_height", (void *)stub_img_height, "(i)i", NULL },
    { "snd_by_name", (void *)wamr_snd_by_name, "(*~)i", NULL },
    { "snd_create_pcm", (void *)stub_snd_create_pcm, "(*~i)i", NULL },
    { "font_by_name", (void *)stub_font_by_name, "(*~)i", NULL },
    { "snd_play", (void *)wamr_snd_play, "(ifi)i", NULL },
    { "snd_stop", (void *)wamr_snd_stop, "(i)", NULL },
    { "snd_set_volume", (void *)wamr_snd_set_volume, "(if)", NULL },
    { "snd_status", (void *)stub_snd_status, "(i)i", NULL },
    { "snd_pause_all", (void *)stub_snd_pause_all, "()", NULL },
    { "snd_resume_all", (void *)stub_snd_resume_all, "()", NULL },
    ...
    { "gfx_offscreen_begin", (void *)stub_gfx_offscreen_begin, "(ii)i", NULL },
    { "gfx_offscreen_end_to_image", (void *)stub_gfx_offscreen_end_to_image, "(i)i", NULL },
    { "gfx_offscreen_end_discard", (void *)stub_gfx_offscreen_end_discard, "(i)", NULL },
    { "gfx_free_image", (void *)stub_gfx_free_image, "(i)", NULL },
    { "gfx_draw_shadow_image", (void *)stub_gfx_draw_shadow_image, "(ifffffi)", NULL },
    { "gfx_set_filter", (void *)stub_gfx_set_filter, "(*~)", NULL },
    { "gfx_clear_filter", (void *)stub_gfx_clear_filter, "()", NULL },
    { "gfx_set_shadow", (void *)stub_gfx_set_shadow, "(fffi)", NULL },
    { "gfx_clear_shadow", (void *)stub_gfx_clear_shadow, "()", NULL },
    { "gfx_set_composite", (void *)stub_gfx_set_composite, "(i)", NULL },
    ...
    { "snd_set_rate", (void *)stub_snd_set_rate, "(if)", NULL },
    { "eng_player_create", (void *)stub_eng_player_create, "()i", NULL },
    { "eng_player_release", (void *)stub_eng_player_release, "(i)", NULL },
    { "eng_mixer_create", (void *)stub_eng_mixer_create, "()i", NULL },
    { "eng_node_set_volume", (void *)stub_eng_node_set_volume, "(if)", NULL },
    { "eng_node_set_pan", (void *)stub_eng_node_set_pan, "(if)", NULL },
    { "eng_connect", (void *)stub_eng_connect, "(ii)", NULL },
    { "eng_player_schedule_buffer", (void *)stub_eng_player_schedule_buffer, "(iii)i", NULL },
    { "eng_player_play", (void *)stub_eng_player_play, "(i)", NULL },
    { "eng_player_stop", (void *)stub_eng_player_stop, "(i)", NULL },
    { "eng_start", (void *)stub_eng_start, "()", NULL },
    { "eng_stop", (void *)stub_eng_stop, "()", NULL },
    ...
    { "gfx_upload_pixels", (void *)stub_gfx_upload_pixels, "(iii*~)i", NULL },
    { "store_get", (void *)wamr_store_get, "(*~*~)i", NULL },
    { "store_set", (void *)wamr_store_set, "(*~*~)", NULL },
    { "asset_exists", (void *)stub_asset_exists, "(*~)i", NULL },
    { "asset_text", (void *)stub_asset_text, "(*~*~)i", NULL },
    ...
    { "win_width", (void *)stub_win_width, "()i", NULL },
    { "win_height", (void *)stub_win_height, "()i", NULL },
    { "win_set_title", (void *)stub_win_set_title, "(*~)", NULL },
    { "win_request_fullscreen", (void *)stub_win_request_fullscreen, "()", NULL },
    { "win_exit_fullscreen", (void *)stub_win_exit_fullscreen, "()", NULL },
    { "win_download", (void *)stub_win_download, "(*~*~)", NULL },
