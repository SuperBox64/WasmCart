...
static void wamr_gfx_draw_sprite(wasm_exec_env_t e, int img, float px, float py, float rot, float sx, float sy, float ax, float ay, float w, float h, float al, int bl, uint32_t c) { gfx_draw_sprite(img, px, py, rot, sx, sy, ax, ay, w, h, al, bl, c); }
static void wamr_gfx_draw_text_xform(wasm_exec_env_t e, int font, const char* utf8, int len, float pxw, float pyw, float rot, float sx, float sy, float lx, int sz, int bl, float al, uint32_t c, float sp) { gfx_draw_text_xform(font, utf8, len, pxw, pyw, rot, sx, sy, lx, sz, bl, al, c, sp); }
...
NativeSymbol kit_natives[] = {
    ...
    { "gfx_translate", (void *)wamr_gfx_translate, NULL, NULL },
    { "gfx_scale", (void *)wamr_gfx_scale, NULL, NULL },
    { "gfx_snap_translation", (void *)wamr_gfx_snap_translation, "()", NULL },
    { "gfx_rotate", (void *)wamr_gfx_rotate, NULL, NULL },
    { "gfx_set_alpha", (void *)wamr_gfx_set_alpha, NULL, NULL },
    { "gfx_set_tint", (void *)wamr_gfx_set_tint, NULL, NULL },
    { "gfx_set_blend", (void *)wamr_gfx_set_blend, "(i)", NULL },
    { "gfx_set_line_style", (void *)wamr_gfx_set_line_style, NULL, NULL },
    { "gfx_fill_rect", (void *)wamr_gfx_fill_rect, NULL, NULL },
    { "gfx_stroke_rect", (void *)wamr_gfx_stroke_rect, NULL, NULL },
    { "gfx_fill_circle", (void *)wamr_gfx_fill_circle, NULL, NULL },
    { "gfx_stroke_circle", (void *)wamr_gfx_stroke_circle, NULL, NULL },
    { "gfx_fill_poly", (void *)wamr_gfx_fill_poly, "(*~i)", NULL },
    { "gfx_stroke_poly", (void *)wamr_gfx_stroke_poly, "(*~ifi)", NULL },
    { "gfx_draw_image", (void *)wamr_gfx_draw_image, NULL, NULL },
    { "gfx_draw_sprite", (void *)wamr_gfx_draw_sprite, NULL, NULL },
    { "gfx_draw_text_xform", (void *)wamr_gfx_draw_text_xform, "(i*~ffffffiifif)", NULL },
    ...
    { "snd_set_volume", (void *)wamr_snd_set_volume, NULL, NULL },
    ...
    { "gfx_draw_shadow_image", (void *)wamr_gfx_draw_shadow_image, NULL, NULL },
    { "gfx_set_filter", (void *)wamr_gfx_set_filter, "(*~)", NULL },
    { "gfx_clear_filter", (void *)wamr_gfx_clear_filter, "()", NULL },
    { "gfx_set_shadow", (void *)wamr_gfx_set_shadow, NULL, NULL },
    ...
    { "vid_set_rect", (void *)stub_vid_set_rect, NULL, NULL },
    { "vid_set_visible", (void *)stub_vid_set_visible, "(ii)", NULL },
    { "snd_set_pan", (void *)wamr_snd_set_pan, NULL, NULL },
    { "snd_set_rate", (void *)wamr_snd_set_rate, NULL, NULL },
    ...
    { "eng_node_set_volume", (void *)wamr_eng_node_set_volume, NULL, NULL },
    { "eng_node_set_pan", (void *)wamr_eng_node_set_pan, NULL, NULL },
    ...
    { "gfx_shader_draw", (void *)wamr_gfx_shader_draw, NULL, NULL },
    { "gfx_lighting_draw", (void *)wamr_gfx_lighting_draw, "(ii*~ffffi)", NULL },
    { "gfx_warp_draw", (void *)wamr_gfx_warp_draw, "(iii**ffffi)", NULL },
    { "gfx_3d_draw_billboard", (void *)wamr_gfx_3d_draw_billboard, NULL, NULL },
